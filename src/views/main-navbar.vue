  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">株式会社XXX</a>
        <a class="site-navbar__brand-mini" href="javascript:;">OGM</a>
      </h1>
    </div>
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="updatePasswordHandle()">パスワードを変更する</el-dropdown-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 退出
      logoutHandle () {
        this.$confirm(`ログアウトしでも宜しいですか`, '提示', {
